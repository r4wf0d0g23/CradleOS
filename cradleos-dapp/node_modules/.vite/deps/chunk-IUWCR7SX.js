  ...
  constructor(ORDER, opts = {}) {
    ...
    if (opts != null && typeof opts === "object") {
      ...
      if (opts.allowedLengths)
        this._lengths = (_a7 = opts.allowedLengths) == null ? void 0 : _a7.slice();
...
var Fn521 = (() => Field(p521_CURVE.n, { allowedLengths: [65, 66] }))();
var p521_Point = weierstrass(p521_CURVE, { Fn: Fn521 });
...
var _a;
var PasskeyPublicKey = (_a = class extends PublicKey {
  /**
...
}, _a.SIZE = PASSKEY_PUBLIC_KEY_SIZE, _a);
...
var _data, _client, _legacyAddress, _ZkLoginPublicIdentifier_instances, toLegacyAddress_fn, _a2;
var ZkLoginPublicIdentifier = (_a2 = class extends PublicKey {
  /**
  ...
  */
  ...
  static fromBytes(bytes, { client, address, legacyAddress } = {}) {
    let publicKey;
    if (legacyAddress === true) publicKey = new _a2(normalizeZkLoginPublicKeyBytes(bytes, true), { client });
    else if (legacyAddress === false) publicKey = new _a2(normalizeZkLoginPublicKeyBytes(bytes, false), { client });
    else if (address) {
      publicKey = new _a2(normalizeZkLoginPublicKeyBytes(bytes, false), { client });
      if (publicKey.toSuiAddress() !== address) publicKey = new _a2(normalizeZkLoginPublicKeyBytes(bytes, true), { client });
    } else publicKey = new _a2(bytes, { client });
  ...
  */
  verifyPersonalMessage(message, signature) {
    ...
    return graphqlVerifyZkLoginSignature({
      address: new _a2(parsedSignature.publicKey).toSuiAddress(),
...
function edwards(params, extraOpts = {}) {
  ...
  const _Point = class _Point {
    ...
    static fromAffine(p) {
      ...
      acoord("x", x);
      acoord("y", y);
      return new _Point(x, y, _1n5, modP(x * y));
    }
  ...
  // base / generator point
  __publicField(_Point, "BASE", new _Point(CURVE.Gx, CURVE.Gy, _1n5, modP(CURVE.Gx * CURVE.Gy)));
  // zero / infinity / identity point
  __publicField(_Point, "ZERO", new _Point(_0n5, _1n5, _1n5, _0n5));
  // 0, 1, 1, 0
  // math field
  __publicField(_Point, "Fp", Fp2);
  // scalar field
...
var _a3;
var Ed25519PublicKey = (_a3 = class extends PublicKey {
  /**
...
var MultiSigSigner = (_a6 = class extends Signer {
  constructor(pubkey, signers = []) {
    ...
    for (const signer of signers) {
      ...
      const weight = (_a7 = weights.find((w) => w.address === address)) == null ? void 0 : _a7.weight;
  ...
  */
  combinePartialSignatures(signatures) {
    ...
    for (let i = 0; i < signatures.length; i++) {
      ...
      let publicKey;
      if (parsed.signatureScheme === "ZkLogin") publicKey = toZkLoginPublicIdentifier((_a7 = parsed.zkLogin) == null ? void 0 : _a7.addressSeed, (_b = parsed.zkLogin) == null ? void 0 : _b.iss, { legacyAddress: false }).toRawBytes();
...
async function verifySignature(bytes, signature, options) {
  ...
  if ((options == null ? void 0 : options.address) && !parsedSignature.publicKey.verifyAddress(options.address)) throw new Error(`Signature is not valid for the provided address`);
...
*/
//# sourceMappingURL=chunk-IUWCR7SX.js.map
