...
function fromHex(hexStr) {
  ...
  const intArr = ((_a3 = padded.match(/[0-9a-fA-F]{2}/g)) == null ? void 0 : _a3.map((byte) => parseInt(byte, 16))) ?? [];
...
function uIntBcsType({ readMethod, writeMethod, ...options }) {
  return fixedSizeBcsType({
    ...
    validate: (value) => {
      ...
      (_a3 = options.validate) == null ? void 0 : _a3.call(options, value);
    }
  });
}
...
var BcsStruct = class extends BcsType {
  constructor({ name, fields, ...options }) {
    ...
    super({
      ...
      validate: (value) => {
        var _a3;
        (_a3 = options == null ? void 0 : options.validate) == null ? void 0 : _a3.call(options, value);
...
*/
//# sourceMappingURL=chunk-UO3DWYTF.js.map
