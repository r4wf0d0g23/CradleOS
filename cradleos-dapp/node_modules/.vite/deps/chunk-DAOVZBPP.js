...
// node_modules/@mysten/slush-wallet/node_modules/@mysten/wallet-standard/dist/chains.mjs
...
var DappPostMessageChannel = (_a3 = class {
  constructor({ appName, hostOrigin, hostPathname = "dapp-request", extraRequestOptions, popupWindow }) {
    ...
    __privateAdd(this, _listener, (event) => {
      ...
      if (output.payload.type === "reject") __privateGet(this, _reject).call(this, new Error("User rejected the request"));
...
//# sourceMappingURL=chunk-DAOVZBPP.js.map
