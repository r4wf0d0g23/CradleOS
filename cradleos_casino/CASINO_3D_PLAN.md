...
| 2026-07-11 | label declutter | Label declutter: switched sizeAttenuation=true (world-sized, ~1.3m wide), distance reveal (opacity=1 ≤7m, linear fade 7→13m, hidden >13m), nearest-station 1.15x emphasis, zone labels as world sprites (~2m wide) in scene. Commit 80da73dd. gh-pages: index-fL3IrWaw.js + Casino3D-ZBqAdJ4U.js (200 verified). CF: Casino3D-BBgSWTHE.js on 2665c87b.cradleos-d75.pages.dev (200 verified). Card art: 12 webp. |
